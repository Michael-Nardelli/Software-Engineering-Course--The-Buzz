...
public class OAuth {
    public static final String CLIENT_ID = "373597156492-u5e6nqr8alh2ucf4c5pe9f01tqjg0kce.apps.googleusercontent.com";
    ...
    public static User OAuthAuthorize(String id_token) throws GeneralSecurityException, IOException {
        ...
        if (idToken != null) {
            ...
            if (!users_hashtable.containsKey(sessionKey))
                users_hashtable.put(sessionKey, email); // check if they are in hashtable
